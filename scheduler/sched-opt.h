...
typedef enum {
    ...
    INDEX_OPT_NOBLOCK             =  6,
    INDEX_OPT_LOGFILE             =  7,
    INDEX_OPT_MPICALLS            =  8,
    INDEX_OPT_VERBOSE             =  9,
    INDEX_OPT_QUIET               = 10,
    INDEX_OPT_RPT_PROGRESS        = 11,
    INDEX_OPT_DISTRIBUTED         = 12,
    INDEX_OPT_FIBOPT              = 13,
    INDEX_OPT_VIEW_PROG_OUT_ONLY  = 14,
    INDEX_OPT_DISABLE_OMP         = 15,
    INDEX_OPT_EXP_MODE            = 16,
    INDEX_OPT_ENV                 = 17,
    INDEX_OPT_EXP_SOME            = 18,
    INDEX_OPT_STOP_AT_DEADLOCK    = 19,
    INDEX_OPT_DEBUG_SCHED         = 20,
    INDEX_OPT_NO_AMPLE_SET_FIX    = 21,
    INDEX_OPT_BOUND               = 22,
    INDEX_OPT_FPRS                = 23,
...
#define VALUE_OPT_DEBUG_SCHED    20
